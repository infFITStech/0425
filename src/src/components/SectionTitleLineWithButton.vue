...
<template>
  <section :class="{ 'pt-6': !main }" class="mb-6 flex items-center justify-between pt-6">
    <div class="flex items-center justify-start w-full pb-1 border-b border-gray-270">
