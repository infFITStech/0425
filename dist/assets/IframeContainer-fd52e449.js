import{r as w,bk as k,a2 as a,q as $,o as I,i as T,b as i,D as y,F as B}from"./index-e90cb2fa.js";const D=i("div",{class:"loadingbar",id:"loadingbar"},[i("div",{class:"spinner spinner-circle"})],-1),C=i("div",{class:"container back",id:"containerback"},null,-1),N={class:"container mbinfo animY",id:"container-recom"},G=i("div",{class:"c_header",id:"container-container-recom-header"},[i("span",null,"推薦給您的商品")],-1),S=i("div",{class:"selection_scroll"},[i("div",{class:"selection"})],-1),R={class:"footer"},E=i("div",{id:"pback"},null,-1),P={__name:"IframeContainer",setup(F){var u;const p=w(""),s=w("");let r=k({});const f=()=>{a(".update_delete").remove(),a("#container-recom").hide(),r={}};window.addEventListener("message",async n=>{n.data.header=="from_preview"&&(await f(),p.value=n.data.id,s.value=n.data.brand,console.log("change clothID: brand:",p.value,s.value),_()),console.log("Message received from parent:",n.data)});const _=async()=>{const n={method:"GET",headers:{accept:"application/json"}};try{var t;if(t=await(await fetch("https://xjsoc4o2ci.execute-api.ap-northeast-1.amazonaws.com/v0/extension/run_product?Brand="+s.value+"&ClothID="+p.value,n)).json(),console.log("obj",t),!t.Product)return;let o=t.Product.Routes[0].TagGroups_order,l={};for(var d=0;d<o.length;d++)l[o[d]]=[];for(var h=0;h<t.RouteConfig.length;h++){let e=t.RouteConfig[h];l[e.TagGroup.S].push(e)}for(var c in l){console.log("TagGroup : "+c),document.getElementById("pback").insertAdjacentHTML("beforebegin",`<div class='container mbinfo animX update_delete' id="container-${c.replaceAll(" ","")}">
                ...
                `)}var m=window.ontouchstart===null?"touchend":"click";a("#container-"+o[0]).show();for(var g=0;g<o.length;g++)(function(e){console.log(".c-"+o[e].replaceAll(" ","")),a(".c-"+o[e].replaceAll(" ","")+".skip").on(m,function(x){e==o.length-1?(a("#container-"+o[e].replaceAll(" ","")).hide(),v()):(console.log(".c-"+o[e+1].replaceAll(" ","")),a("#container-"+o[e].replaceAll(" ","")).hide(),a("#container-"+o[e+1].replaceAll(" ","")).show())}),a(".c-"+o[e].replaceAll(" ","")+":not(.skip)").on(m,function(x){e==o.length-1?(a("#container-"+o[e].replaceAll(" ","")).hide(),r[o[e].replaceAll(" ","")]=[{Description:"example",Imgsrc:"https://example.com/imageB1.png",Name:"example",Tag:"example",TagGroup:o[e]}],v()):(a("#container-"+o[e].replaceAll(" ","")).hide(),a("#container-"+o[e+1].replaceAll(" ","")).show(),r[o[e]]=[{Description:"example",Imgsrc:"https://example.com/imageB1.png",Name:"example",Tag:"example",TagGroup:o[e]}])}),a(`#container-${o[e].replaceAll(" ","")}-backarrow`).on(m,function(x){e!=0&&(a("#container-"+o[e].replaceAll(" ","")).hide(),a("#container-"+o[e-1].replaceAll(" ","")).show())}),e==0&&(u=function(){a("#container-"+o[e].replaceAll(" ","")).show(),a("#container-recom").hide(),a("#container-recom").find(".selection").children().remove(),r={}})})(g);a("#loadingbar").hide(),a("#pback").show(),a("#containerback").show()}catch(b){console.error("Fetch error:",b)}};$(()=>{_()});const v=()=>{a("#loadingbar").show();let n={method:"POST",headers:{accept:"application/json","content-type":"application/json"},body:JSON.stringify({Brand:s.value,Tags:r})};console.log("tags chosen:",r),fetch("https://ldiusfc4ib.execute-api.ap-northeast-1.amazonaws.com/v0/extension/recom_product",n).then(t=>t.json()).then(t=>{A(t)}).catch(t=>console.error(t))},A=n=>{a("#loadingbar").hide(),a("#container-recom").show(),console.log(n);for(let t=0;t<n.Item.length;t++)a("#container-recom").find(".selection").append(`
    ...
    `)};return(n,t)=>(I(),T(B,null,[D,C,i("div",N,[G,S,i("div",R,[i("button",{id:"startover",class:"startover enabled",onClick:t[0]||(t[0]=d=>y(u)()),style:{width:"auto","margin-bottom":"5px"}},"重新輸入 ")])]),E],64))}};export{P as default};
